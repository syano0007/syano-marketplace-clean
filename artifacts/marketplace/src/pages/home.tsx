            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-6 bg-card border rounded-2xl p-6 md:p-8 shadow-sm">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold">{t("home.courier_cta_title")}</h3>
                    <p className="text-sm text-muted-foreground mt-0.5">{t("home.courier_cta_desc")}</p>
                  </div>
                </div>
                <Button variant="outline" className="shrink-0 h-11 px-6 font-semibold w-full sm:w-auto" onClick={handleBecomeCourier}>
