...
const STATUS_CONFIG: Record<string, {
  ...
  approved:  { color: "bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-400 border-emerald-200 dark:border-emerald-800", icon: CheckCircle2, iconClass: "text-emerald-500", labelKey: "delivery.status_approved" },
          ...
          <div className="bg-card border rounded-2xl p-5">
            ...
            <div className="flex items-center gap-3 flex-wrap">
              ...
              {courier.status === "approved" && courier.active && (
                <span className="text-sm font-semibold px-3 py-1.5 rounded-full border bg-emerald-50 text-emerald-700 dark:bg-emerald-900/20 dark:text-emerald-400 border-emerald-200 dark:border-emerald-800">
