...
const AVAIL_CONFIG = {
  ONLINE:  { label: "Online",  labelAr: "متاح",      color: "text-emerald-400 bg-emerald-400/10 border-emerald-500/30", dot: "bg-emerald-400", icon: Wifi },
    ...
    <AdminLayout>
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-3 gap-4">
          {[
            { label: isRtl ? "متاحون" : "Online",  value: onlineCount,  cls: "text-emerald-400" },
