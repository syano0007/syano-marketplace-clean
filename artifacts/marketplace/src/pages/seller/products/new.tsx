              ...
              <div className={`space-y-4 p-4 rounded-xl border transition-colors duration-200 ${variantsEnabled ? "bg-primary/5 border-primary/20" : "bg-muted/30"}`}>
                <div className="flex items-start gap-3">
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-muted-foreground mt-0.5">{t("variants.section_desc")}</p>
                  </div>
                  <div className="flex items-center gap-2 shrink-0 mt-0.5">
                    ...
                    <button
                      ...
                      className={`relative h-6 w-11 rounded-full transition-colors duration-200 shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 ${variantsEnabled ? "bg-primary shadow-sm shadow-primary/30" : "bg-muted-foreground/30"}`}
                    >
                      <span
