        ...
        <div className="bg-card border rounded-xl p-6 shadow-sm">
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              {/* Variants section */}
              <div className={`space-y-4 p-4 rounded-xl border transition-colors duration-200 ${variantsEnabled ? "bg-primary/5 border-primary/20" : "bg-muted/30"}`}>
                <div className="flex items-start gap-3">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-0.5">
                      <Layers className="h-4 w-4 text-primary" />
                      <p className="text-sm font-semibold">{t("variants.section_title")}</p>
                    </div>
                    <p className="text-xs text-muted-foreground">{t("variants.section_desc")}</p>
                  </div>
                  <div className="flex items-center gap-2 shrink-0 mt-0.5">
                    <span className={`text-xs font-medium transition-colors duration-200 ${variantsEnabled ? "text-primary" : "text-muted-foreground"}`}>
                    ...
                    <button
                      ...
                      className={`relative h-6 w-11 shrink-0 rounded-full transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 touch-manipulation ${variantsEnabled ? "bg-primary shadow-sm shadow-primary/30" : "bg-muted-foreground/30"}`}
                    >
                      <span
