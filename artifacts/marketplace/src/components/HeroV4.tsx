  ...
  return (
    <div style={{
      ...
      <div style={{ flex:1, textAlign:"right" }}>
        ...
        {card.avail && (
          <div style={{ fontSize:9.5, color:"#10b981", display:"flex", alignItems:"center", gap:3, justifyContent:"flex-end" }}>
            {card.avail}
          </div>
        )}
      </div>
        ...
        <h1 style={{
          ...
          {isRTL ? (
            ...
            <>
              ...
              of <span style={{ color:"#10b981" }}>Syrian Products.</span>
            </>
          )}
        </h1>
          ...
          {(hasBanners ? banners : HERO_SLIDES).map((_, i) => (
            <button
              ...
              style={{
                border:"none", cursor:"pointer", padding:0, borderRadius:100,
                transition:"all 0.3s",
                background: i === (hasBanners ? bannerIdx : slideIdx) ? "#10b981" : "rgba(255,255,255,0.25)",
