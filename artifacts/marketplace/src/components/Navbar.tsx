...
export function Navbar() {
  ...
  const courierLinks = useMemo(() => [
    { href: "/courier/dashboard", icon: LayoutDashboard, label: t("nav.dashboard") },
    { href: "/courier/dashboard", icon: Package,         label: t("courier.my_deliveries") },
  ], [t]);
      ...
      <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
        ...
        <SheetContent side={isRtl ? "right" : "left"} className="w-[min(300px,78vw)] p-0 flex flex-col" aria-describedby={undefined}>
          ...
          <div className="flex-1 overflow-y-auto px-3 py-4 space-y-0.5">
            ...
            {isCourier && (
              <MobileNavLink href="/courier/dashboard" icon={Package} label={t("courier.dashboard_title")} location={location} onClose={closeMobileMenu} />
            )}
