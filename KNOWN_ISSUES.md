...
**Severity:** Low  
**Status:** By design  
**Description:** Login rate limiting (5 attempts/hour per IP) uses in-memory state. Restarting the API server resets all rate limit counters. In production, this should use Redis or a DB-backed store.
